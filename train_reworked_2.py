...
task = Task.init(
    project_name="Mentor Group D/Group 3/JarroTeunissen",  # Replace YourName with your own name
...
wandb_callback = WandbCallback(
    ...
    model_save_path=f"models2/{run.id}",
    verbose=2,)
...
# Save the model.
model.save(f"models2/{run.id}/{timesteps}_baseline")
# Save the model to wandb
wandb.save(f"models2/{run.id}/{timesteps}_baseline")


# python train_reworked_2.py --learning_rate 0.0001 --batch_size 64 --n_steps 2048 --n_epochs 10